...
from gifpgn.geometry import rotate_around_point, angle_between_two_points, shorten_line, line_intersection
...
def test_angle_between_two_points():
    ...
    assert angle_between_two_points(Coord(0, 0), Coord(10, 10)) == pytest.approx(
        angle_between_two_points(Coord(0, 0), Coord(30, 30)), abs=1e-14
    )
